...
int baronCard(int choice1, struct gameState *state, int currentPlayer, int handPos){
    ...
    if (choice1 > 0) { //Boolean true or going to discard an estate
        ...
        //bug added.  value of card_not_discarded changed from 1 to 0.
        ...
        if (supplyCount(estate, state) > 0) {
            ...
            //bug added.  supply count of estates increments instead of decrements.
            state->supplyCount[estate]++;//Decrement Estates
            if (supplyCount(estate, state) == 0) {
                isGameOver(state);
            }
...
int tributeCard(struct gameState *state, int tributeRevealedCards[], int nextPlayer, int currentPlayer, int handPos){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    //refactored and moved to separate function
    case baron:
    ...
    //refactored and moved to separate function
    case minion:
        return minionCard(choice1, choice2, state, handPos, currentPlayer);
    ...
    //refactored and moved to separate function
    case tribute:
        return tributeCard(state, tributeRevealedCards, nextPlayer, currentPlayer, handPos);
